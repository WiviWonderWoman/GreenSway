...
export function showBuisnessPlan() {
    ...
    <div class="flex.container">
        ...
        <div><img src="${image1}" alt="woman swinging over green landscape"></div>
        <div>
    ...
    <div class="flex.container">
        <div><img src="${image2}" alt="balance scale"></div>
        <div>
            <h2>Syfte & Mål</h2>
        ...
        <div><img src="${image3}" alt="floor plan of the block before"></div>
        ...
        <div><img src="${image4}" alt="floor plan of the block after"></div>
    </div>
